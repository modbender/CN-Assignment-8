...
def main():
    ...
    aparser.add_argument('-p' , type=str , type = int, nargs = 1, dest = 'sport', help = 'Server Port Number', required = True)
    aparser.add_argument('-P' , type=str , type = int, nargs = 1, dest = 'cport', help = 'Client Port Number', required = True)
